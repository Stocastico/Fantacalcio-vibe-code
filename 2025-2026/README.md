# Archivio stagione 2025/26

> ⚠️ **Questa cartella è un archivio congelato.** Contiene la versione usata per l'asta e
> il mercato di riparazione della stagione 2025/26, così com'era a fine stagione.
> Non riceve più correzioni: contiene bug noti sulla ridistribuzione dei crediti e
> sull'annullamento degli acquisti, corretti nella versione nuova.
>
> La versione attiva è nella **root del repository**. Vedi il [README principale](../README.md).
>
> La lista giocatori qui dentro è offuscata con passphrase (`players.js`, variabile `OBF`).
> Nella versione nuova l'offuscamento è stato rimosso: l'asta si fa in presenza e non serve.
